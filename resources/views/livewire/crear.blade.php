<div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400">
    ...
    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <div class="mb-4">
            ...
            <select id="puesto" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" wire:model="Puesto">
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sueldo" wire:model="Sueldo">
        </div>

        <div class="mb-4">
            <label for="sucursal" class="block text-gray-700 text-sm font-bold mb-2">Sucursal:</label>
            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sucursal" wire:model="Sucursal">
        </div>
...
@if ($errors->any())
            ...
            <strong>OH NO !</strong> Los siguiente datos NO son correctos<br><br>
                <ul>
